...
// Source: github.com/iruldev/sqlc-crud/database/sqlc (interfaces: Store)
...
func (m *MockStore) AddAccountBalance(arg0 context.Context, arg1 database.AddAccountBalanceParams) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateAccount(arg0 context.Context, arg1 database.CreateAccountParams) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateEntry(arg0 context.Context, arg1 database.CreateEntryParams) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateTransfer(arg0 context.Context, arg1 database.CreateTransferParams) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateUser(arg0 context.Context, arg1 database.CreateUserParams) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetAccountByOwner(arg0 context.Context, arg1 string) (database.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListAccount(arg0 context.Context, arg1 database.ListAccountParams) ([]database.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateAccount(arg0 context.Context, arg1 database.UpdateAccountParams) error {
	m.ctrl.T.Helper()
